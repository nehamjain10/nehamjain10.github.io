...
- **Fall 2025**: [SmokeSeer](https://imaging.cs.cmu.edu/smokeseer/) accepted as a poster at 3DV 2026!
...
|--------------|--------------------------------|
| **ML/DL** | PyTorch, JAX, Ray, Distributed Training, Apache Spark |
| **3D/Graphics** | OpenGL, Vulkan, 3D Gaussian Splatting |
