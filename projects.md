...
<div class="xp">
  <div class="xp-head">
    <h2>3D-Aware Vision-Language-Action Policies</h2>
    <span class="xp-meta">CMU · Spring 2025</span>
  </div>
  <p class="xp-role">Robot Learning course · Manipulation</p>
  <ul>
    <li>Studied how RGB features and depth-derived scene geometry complement language conditioning in action prediction.</li>
    <li>Probed the role of explicit geometry in sample efficiency, viewpoint generalization, and spatial reasoning under occlusion.</li>
  </ul>
</div>
